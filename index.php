...
<body>
    ...
    <!-- Hero Section dengan Tombol Tambah Buku -->
    <section class="hero">
        <div class="container">
...
<section class="stats">
    <div class="container">
        ...
        $database_file = __DIR__ . '/config.php';
...
<section class="books-section">
    <div class="container">
        <div class="section-header">
            <h2>Koleksi Buku</h2>
                <!-- Tombol Tambah Buku di Hero Section -->
    ...
    <div id="bookModal" class="modal">
        <div class="modal-content">
            ...
            <form id="bookForm" action="proses_buku.php" method="POST">
